...
# Toggle Settings App
qs -p ~/.config/quickshell ipc call settings toggle

# Toggle Welcome App
qs -p ~/.config/quickshell ipc call welcome toggle
...
onClicked: {
    ...
    Quickshell.execute(["qs", "-p", Quickshell.env("HOME") + "/.config/quickshell", "ipc", "call", "settings", "open"])
}
